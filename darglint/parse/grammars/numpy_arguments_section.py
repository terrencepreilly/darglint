# Generated on 2020-03-07 09:20:14.507829
...
class ArgumentsGrammar(BaseGrammar):
    productions = [
        ...
        P("arguments-body", ([], "argument-item-header", "arguments-body0", 0), ([], "argument-item-header", "argument-item-body", 0)),
        P("argument-item-header", ([ArgumentItemIdentifier], "ident-list", "newline", 0), ([ArgumentItemIdentifier], "ident-list", "argument-item-header2", 0), ([ArgumentItemIdentifier, ArgumentTypeIdentifier], "ident-list", "argument-item-header4", 0)),
        ...
        P("arguments-section2", ([], "arguments-body", "newlines", 0), ([], "argument-item-header", "arguments-body0", 0), ([], "argument-item-header", "argument-item-body", 0)),
        ...
        P("argument-item-header2", ([], "colon", "newline", 0)),
